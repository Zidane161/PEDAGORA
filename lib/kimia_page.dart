...
class KimiaGuruPage extends StatefulWidget {
  const KimiaGuruPage({super.key});

  @override
  State<KimiaGuruPage> createState() => _KimiaGuruPageState();
}

class _KimiaGuruPageState extends State<KimiaGuruPage> {
  ...
  Future<void> fetchGuruList() async {
    final response = await http.get(
      Uri.parse('http://192.168.50.31/pedagora_api/get_guru_by_pelajaran.php?pelajaran_id=12'),
    );
