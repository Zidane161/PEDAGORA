...
class FisikaGuruPage extends StatefulWidget {
  const FisikaGuruPage({super.key});

  @override
  State<FisikaGuruPage> createState() => _FisikaGuruPageState();
}

class _FisikaGuruPageState extends State<FisikaGuruPage> {
  ...
  Future<void> fetchGuruList() async {
    final response = await http.get(
      Uri.parse('http://192.168.50.31/pedagora_api/get_guru_by_pelajaran.php?pelajaran_id=11'),
    );
